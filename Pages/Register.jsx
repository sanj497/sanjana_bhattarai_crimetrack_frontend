        ...
        <div className="relative z-10">
          ...
          <div className="max-w-md mt-12">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-[8px] bg-white/10 text-[#00B8D9] font-medium text-xs mb-6 border border-white/5 backdrop-blur-sm">
              <Activity className="h-4 w-4" /> Create Your Account
            </div>
            <h1 className="text-4xl lg:text-5xl font-bold mb-6 leading-tight" style={{ fontFamily: "Poppins, sans-serif" }}>
              Join CrimeTrack. <br /><span className="text-[#00B8D9]">Stay Safe.</span>
            </h1>
            <p className="text-lg text-gray-400 leading-relaxed mb-8">
              Sign up to report crimes, receive safety alerts, and help protect your community.
            </p>
          </div>
        </div>
          ...
          {step === "register" && (
            <>
              <div className="mb-10 text-center md:text-left">
                <h2 className="text-3xl font-bold text-[#0B1F3B] mb-2" style={{ fontFamily: "Poppins, sans-serif" }}>Create Account</h2>
                <p className="text-[#6B7280]">Choose your role and verify your email to get started.</p>
              </div>

              <form onSubmit={handleRegister} className="space-y-5">
                <div className="space-y-1">
                  <label className="text-sm font-semibold text-[#0B1F3B]">I am a</label>
                ...
                <div className="space-y-1">
                  <label className="text-sm font-semibold text-[#0B1F3B]">Location</label>
                  <div className="relative">
                     <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                ...
                {form.confirmPassword && form.password !== form.confirmPassword && (
                    <p className="text-xs text-red-500 font-semibold -mt-2 inline-flex items-center gap-1"><Activity className="h-3 w-3" /> Passwords do not match.</p>
                )}
