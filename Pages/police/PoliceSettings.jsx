...
export default function PoliceSettings() {
  const [profile, setProfile] = useState({ username: "", email: "", profilePicture: null, stationDistrict: "" });
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto font-sans">
      <div className="mb-10">
        <h1 className="text-3xl font-black text-slate-900 tracking-tight">Officer Profile Settings</h1>
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input 
                type="text" 
                className="w-full pl-12 pr-4 py-3.5 bg-slate-50 border border-slate-100 rounded-2xl focus:bg-white focus:ring-2 focus:ring-blue-500/10 focus:border-blue-500 transition-all outline-none text-sm font-semibold text-slate-900"
          ...
          {profile.stationDistrict && (
            <div>
              <label className="text-[11px] font-black uppercase text-slate-400 mb-2 block ml-1">Station District</label>
              <div className="px-4 py-3.5 bg-slate-50 border border-slate-100 rounded-2xl text-sm font-semibold text-slate-700">
                {profile.stationDistrict}
              </div>
            </div>
          )}
